...
| POST | `/watchlist/<user_id>/remove` | Remove a film from the watchlist |
...
**WatchlistEntry** — Links a user to a film they want to watch. Stores visibility (public) and date added. A user can only have one entry per film.
